...
if (class_exists('Klick_Apv_Notifier')) return;

/**
 * Class Klick_Apv_Notifier
 */
class Klick_Apv_Notifier {
	...
	/**
	 * klick_apv_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_APV_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_APV_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
	...
	/**
	 * Prepare a list of notices available for this position, select 1 at random and render call the notice to render itself
	 *
